...
// * @since 8/14/15.
// */
//public class ServiceHandler extends AsyncTask<String, Void, ArrayList<DiscoverMovieResponse>> {
//    public String LOG = "LOG";
//
//    private ArrayAdapter<DiscoverMovieResponse> mMovieAdapter;
//    private final Context mContext;
//
//    public ServiceHandler(Context context, ArrayAdapter<DiscoverMovieResponse> movieAdapter) {
//        mContext = context;
//        mMovieAdapter = movieAdapter;
//    }
//
//    private ArrayList<DiscoverMovieResponse> getMovieData(String movieString)
...
//
//        ArrayList<DiscoverMovieResponse> movies = new ArrayList<>();
...
//
//            movies.add(new DiscoverMovieResponse(movie_id, title, summary, release_date, vote_avg, poster));
//
//        }
//        return movies;
//    }
...
//
//    @Override
//    protected ArrayList<DiscoverMovieResponse> doInBackground(String... params) {
...
//
//    @Override
//    protected void onPostExecute(ArrayList<DiscoverMovieResponse> movies) {
